...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    dump.sh --cmd "$train_cmd" --nj 80 --do_delta $do_delta \
        ../asr1b/data/${train_set}/feats.scp ../asr1b/data/${train_set}/cmvn.ark exp/dump_feats/${train_set} ${feat_tr_dir}
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    wc -l ${dict}
    rm data/lang_1spm/all_input.txt
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    mkdir -p ${lmdatadir}
    grep sp1.0 ../asr1b/data/${train_set}/text.${case} | cut -f 2- -d " " | spm_encode --model=${bpemodel}.es.model --output_format=piece \
        > ${lmdatadir}/train_${case}.txt
    cut -f 2- -d " " ../asr1b/data/${train_dev}/text.${case} | spm_encode --model=${bpemodel}.es.model --output_format=piece \
